...
function publishDraftRelease(draftRelease, version) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const { data: publishedRelease } = yield octokit.repos.updateRelease(Object.assign(Object.assign({}, github_1.context.repo), { draft: false, name: draftRelease.name || version, prerelease: isPrerelease, release_id: draftRelease.id, tag_name: version, target_commitish: process.env.GITHUB_SHA }));
